...
test.skip('@APITests sandbox banner is shown when 6 events are returned', async ({ page }) => {
...
test.skip('@APITests sandbox banner is hidden when 4 events are returned', async ({ page }) => {
  await page.route('**/api/events**', async (route) => {
    await route.fulfill({
      status:      200,
      contentType: 'application/json',
